...
#Importação de multi rede neural
from sklearn.neural_network import MLPClassifier
#Definição de variável para MPLC com parâmetros já setados
classificador = MLPClassifier(verbose = True,
                              ...
                              activation = 'relu')
#Aplicação do MPLC nos df's previsores e classe
classificador.fit(previsores_treinamento, classe_treinamento)
#Criação de variável com resultados do MPLC
